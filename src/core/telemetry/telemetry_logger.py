...
class TelemetryLogger:
    ...
    def __init__(self, output_dir: Optional[Path] = None):
        ...
        self._setup_logger("system", "system.log")
        self._setup_logger("resources", "resources.log")
        ...
        # Log de inicio
        self.system.info(f"Session started: {self.session_timestamp} at {self.session_start}")
    ...
    def _setup_logger(self, name: str, filename: str):
        ...
        handler = logging.FileHandler(self.output_dir / filename)
    ...
    def log_frame_performance(
        ...
        self.performance.info(json.dumps(data))
    ...
    def log_detection(
        ...
        self.detections.info(json.dumps(asdict(metric)))
    ...
    def log_audio_event(
        ...
        self.audio.info(json.dumps(asdict(metric)))
    ...
    def _log_system_event(self, event_type: str, data: Dict[str, Any]) -> None:
        ...
        self.system.info(json.dumps(payload))
    ...
    def log_resources(self, resource_data: Dict[str, Any]) -> None:
        ...
        self.resources.info(json.dumps(payload))
