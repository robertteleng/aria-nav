...
### Technical Deep Dive
- **[CUDA_OPTIMIZATION.md](CUDA_OPTIMIZATION.md)** - Complete consolidated guide (archivado)
...
- [PROJECT_TIMELINE.md](../history/PROJECT_TIMELINE.md) - Complete development history
